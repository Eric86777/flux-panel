...
### Docker Compose部署
```bash
curl -L https://raw.githubusercontent.com/Eric86777/flux-panel/refs/heads/main/panel_install.sh -o panel_install.sh && chmod +x panel_install.sh && ./panel_install.sh
```
